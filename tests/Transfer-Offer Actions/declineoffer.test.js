...
test("decline offer", async () => {
    ...
    await atomicassets.contract.declineoffer({
        offer_id: 1
    }, [{
...
test("throw without authorization from the offer recipient", async () => {
    await atomicassets.loadFixtures("offers", {
        "atomicassets": [{
            offer_id: "1",
            sender: user1.accountName,
    ...
    await expect(atomicassets.contract.declineoffer({
        offer_id: 1
    }, [{
